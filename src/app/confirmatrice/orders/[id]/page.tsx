...
// Numéros de téléphone des confirmatrices
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 24, flexWrap: 'wrap' }}>
        ...
        {!editMode ? (
          <div style={{ display: 'flex', gap: 8 }}>
            <a
              href={buildWhatsAppUrl(order, currentUser?.email)}
              target="_blank"
              rel="noreferrer"
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <InfoRow icon="📱" label="Téléphone" value={
                <span style={{ display: 'inline-flex', alignItems: 'center', gap: 8 }}>
                  ...
                  <a href={buildWhatsAppUrl(order, currentUser?.email)} target="_blank" rel="noreferrer" title="WhatsApp" style={{ display: 'inline-flex', alignItems: 'center', padding: '2px 6px', background: '#25D366', borderRadius: 4, textDecoration: 'none' }}>
