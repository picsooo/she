...
export function CategorySidebar({ categories, currentCategoryIds = [] }: CategorySidebarProps) {
  ...
  return (
    ...
    >
      ...
      <div className="rounded-2xl bg-[#FFF0F7] border border-[#E93D91]/20 p-3 text-center">
        <p className="text-xs font-bold text-[#E93D91]">💬 هل لديكِ سؤال؟</p>
        <p className="mt-1 text-[10px] text-foreground/50">تواصلي معنا مباشرة عبر واتساب</p>
        <a
          href="https://wa.me/213550000000"
          target="_blank"
          rel="noopener noreferrer"
          className="mt-2 inline-flex items-center gap-1.5 rounded-full bg-green-500 px-3 py-1.5 text-[10px] font-bold text-white hover:bg-green-600 transition-colors"
        >
